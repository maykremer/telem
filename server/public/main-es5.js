...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_2__["MatInputModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_3__["BrowserAnimationsModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_4__["MatRadioModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_5__["MatSelectModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_8__["MatButtonModule"]]]
    });
  ...
  function srcAppMainMainComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function MainComponent_tr_11_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function MainComponent_tr_11_Template_mat_radio_button_change_3_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);

          var ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r4.unitSelected($event);
        });
    ...
    function MainComponent_mat_option_16_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var MainComponent = /*#__PURE__*/function () {
      function MainComponent(http) {
        ...
        this.bases = ['בסיס 1', 'בסיס 2', 'בסיס 3', 'בסיס 4', 'בסיס 5 ']; // name: string = '';
        // armyId: string = '';
        // unit: string = '';
        // location: string = '';
      ...
      _createClass(MainComponent, [{
        ...
        key: "unitSelected",
        value: function unitSelected(event) {
        ...
        value: function checkData() {
          return Object.values(this.postData).some(function (value) {
            return value === '';
          });
        }
      }, {
        ...
        value: function addPerson() {
          console.log("name:  ".concat(this.postData.name));
          console.log("army id:  ".concat(this.postData.armyId));
          console.log("unit:  ".concat(this.postData.unit));
          console.log("location:  ".concat(this.postData.location));
          console.log("post data:  ".concat(this.postData));
          this.http.post('http://localhost:3000/', this.postData).subscribe(function (responseData) {
    ...
    MainComponent.ɵfac = function MainComponent_Factory(t) {
      return new (t || MainComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
    };
    ...
    MainComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function MainComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function MainComponent_Template_input_ngModelChange_5_listener($event) {
            return ctx.postData.name = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function MainComponent_Template_input_ngModelChange_7_listener($event) {
            return ctx.postData.armyId = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function MainComponent_Template_mat_select_change_15_listener($event) {
            return ctx.locationSelected($event);
          })("valueChange", function MainComponent_Template_mat_select_valueChange_15_listener($event) {
            return ctx.postData.location = $event;
          });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\May Kremer\Desktop\telemProject\client\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
